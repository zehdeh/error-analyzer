#############################################################################
# Makefile for building: error-analyzer
...
INCPATH       = -I. -Iinclude/ -isystem /usr/include/vtk-6.2 -isystem /usr/include/x86_64-linux-gnu/qt5 -isystem /usr/include/x86_64-linux-gnu/qt5/QtOpenGL -isystem /usr/include/x86_64-linux-gnu/qt5/QtWidgets -isystem /usr/include/x86_64-linux-gnu/qt5/QtGui -isystem /usr/include/x86_64-linux-gnu/qt5/QtCore -I. -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = error-analyzer1.0.0
DISTDIR = /home/fabian/code/error-analyzer/.tmp/error-analyzer1.0.0
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lvtkGUISupportQt-6.2 -lvtkRenderingCore-6.2 -lvtkRenderingVolume-6.2 -lvtkCommonCore-6.2 -lvtkInteractionStyle-6.2 -lvtkRenderingVolumeOpenGL-6.2 -lvtkCommonExecutionModel-6.2 -lvtkIOImage-6.2 -lvtkIOLegacy-6.2 -lvtkRenderingOpenGL-6.2 -lvtkCommonDataModel-6.2 -lvtkImagingGeneral-6.2 -lvtkIOGeometry-6.2 -lQt5OpenGL -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
